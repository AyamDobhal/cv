...
const Navbar = () => {
  ...
  return (
    <header className='w-full px-6 py-4 font-medium flex items-center justify-between dark:text-light relative z-10 bg-transparent lg:px-16 md:px-12 print:hidden'>
